...
\label{sec:1}
 ...
 In the past, similar studies have been conducted using EEG datasets to analyze and make predictions on epilectic seizures and tumor related activity. The most common classifier used was support vector machine (SVM) and K Near Neighborhoods (KNN) for datasets like CHB-MIT and UCI database. 

In the last years more work has been done using neural networks and deep learning.  Most of these works present a much better results regardless dataset been used.
...
Diyuan Lu, Jochen Triesch& $[$26$]$ - image classification and object recognition methods based on convolutional neural networks  & 2019 \\
...
$[$25$]$ Pierre Thodorof, Joelle Pineau, Andrew Lim - Learning Robust Features using Deep Learning for Automatic Seizure Detection

$[$26$]$ Diyuan Lu, Jochen Triesch - Residual Deep Convolutional Neural Network for
EEG Signal Classification in Epilepsy
